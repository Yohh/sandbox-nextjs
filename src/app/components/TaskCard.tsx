...
const TaskCard = ({ task, index }: taskCardProps) => {
  ...
  return (
    <div>
      ...
      >
        <div
          className="w-full lg:w-3/4 text-left cursor-pointer"
          role="button"
        ...
        <div className="flex bg-orange-300 px-3 rounded-tl-lg rounded-br-xl border-t-2 border-t-orange-600">
          <button
          ...
          <button
            ...
            className="w-6 px-1 m-1 rounded bg-red-600 hover:bg-red-400 text-white"
            onClick={() => {
              deleteTask(task.id);
            }}
          >
